...
export function ReceiptVoucherModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <Card className="relative z-10 w-full sm:max-w-md shadow-2xl animate-slide-up sm:animate-none rounded-t-2xl rounded-b-none sm:rounded-xl overflow-y-auto max-h-[92vh]">
