...
export const DEFAULT_COA: readonly CoaAccount[] = [
  ...
  { code: '1140', nameAr: 'سلف الموظفين',                     nameEn: 'Employee Advances',              type: 'asset'     },
  ...
  { code: '2390', nameAr: 'استقطاعات رواتب مستحقة',           nameEn: 'Payroll Deductions Payable',     type: 'liability' },
  ...
  { code: '2510', nameAr: 'مكافأة نهاية الخدمة مستحقة',       nameEn: 'EOSB Payable',                   type: 'liability' },
