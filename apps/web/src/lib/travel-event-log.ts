...
interface TravelEventParams {
  agencyId:      string;
  eventType:     string;  // pnr_created|ticket_issued|ticket_voided|ticket_refunded|pnr_cancelled|pnr_expired|pnr_linked_to_booking|pnr_linked_to_customer|pnr_sync_started|pnr_sync_completed|pnr_sync_failed|search
