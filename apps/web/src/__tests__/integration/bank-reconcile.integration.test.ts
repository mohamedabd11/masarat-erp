...
describe('bank_transactions — تسجيل الحركات وتحديثها', () => {
...
describe('bank_reconcile — مطابقة بنكية في قاعدة بيانات حقيقية', () => {
...
describe('agency_counters — عداد قيود المطابقة', () => {
